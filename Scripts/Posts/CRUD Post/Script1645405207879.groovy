...
response = WS.sendRequest(findTestObject('Posts/Create Post', [('title') : title, ('body') : body, ('userId') : GlobalVariable.userId]), 
...
response = WS.sendRequest(findTestObject('Posts/Get Post By Id', [('postId') : GlobalVariable.postId]))
...
response = WS.sendRequest(findTestObject('Posts/Delete Post By Id', [('postId') : GlobalVariable.postId]))
